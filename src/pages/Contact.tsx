          ...
          >
            ...
            <div className='card'>
              ...
              <p className='text-light-darker mb-6'>
                Follow me on social media or check out my work on GitHub. I'm always open to new
          ...
          >
            <div className='card'>
              ...
              <Form form={form} layout='vertical' onFinish={onFinish} requiredMark={false}>
                ...
                >
                  <Input className='contact-input' placeholder='Your email address' />
                </Form.Item>
                ...
                >
                  <Input className='contact-input' placeholder='Subject of your message' />
                </Form.Item>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className='card'>
              ...
              <p className='text-light-darker'>
                I specialize in full-stack web development, including frontend development with
                React.js, backend development with Node.js, database design, and API development.
              </p>
            </div>

            <div className='card'>
              <h3 className='text-xl font-bold mb-3'>What is your typical project process?</h3>
              <p className='text-light-darker'>
                My process typically includes requirements gathering, planning, design, development,
                testing, and deployment. I maintain clear communication throughout the project
                lifecycle.
              </p>
            </div>
            ...
            <div className='card'>
              ...
              <p className='text-light-darker'>
                Yes, I'm available for freelance projects. I can work on both short-term and
                long-term engagements, depending on the project requirements and timeline.
              </p>
            </div>
            ...
            <div className='card'>
              ...
              <p className='text-light-darker'>
                Project pricing depends on the scope, complexity, and timeline. I offer both
                fixed-price and hourly rate options. Contact me with your project details for a
                custom quote.
              </p>
            </div>
          </div>
